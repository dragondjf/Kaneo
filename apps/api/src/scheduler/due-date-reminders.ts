    ...
    .where(
      and(
        ...
        reminderType === "configured_before"
          ? sql`${taskTable.dueDate} - (COALESCE(${userNotificationPreferenceTable.dueDateReminderLeadTimeMinutes}, 1440) * 60000) BETWEEN ${windowStart.getTime()} AND ${windowEnd.getTime()}`
